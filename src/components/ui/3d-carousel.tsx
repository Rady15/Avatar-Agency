                    ...
                    {cards.map((imgUrl, i) => (
                        ...
                        >
                            <motion.img
                                ...
                                alt={`keyword_${i}`}
                                layoutId={`img-${imgUrl}`}
                                className="pointer-events-none w-full rounded-xl object-cover aspect-square shadow-2xl border border-white/10"
            ...
            <AnimatePresence mode="sync">
                {activeImg && (
                    <motion.div
                        ...
                        layout="position"
                        onClick={handleClose}
                        className="fixed inset-0 bg-black/80 backdrop-blur-md flex items-center justify-center z-[100] p-4 md:p-20"
