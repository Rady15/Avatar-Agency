...
const servicesList = [
  ...
  { id: "digital", label: "التسويق الالكتروني", labelEn: "Digital Marketing", icon: Megaphone, color: "#ef4444", description: "الحملات التسويقية على سناب وتيك توك وجوجل", descriptionEn: "Marketing campaigns on Snapchat, TikTok and Google" },
...
export function PortfolioSection({ showBackground = true }: { showBackground?: boolean }) {
  ...
  // Removed scroll-linked opacity transformations to meet user request for no transparency/fades
  return (
